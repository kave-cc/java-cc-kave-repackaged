...
import cc.kave.repackaged.jayes.factor.opcache.IOperationCache;
import cc.kave.repackaged.jayes.factor.opcache.ModuloCache;
...
public abstract class AbstractFactor implements Cloneable {
     ...
     * 
     * @param ids array of dimension ids
     */
